...
class ScanFaceForm extends StatefulWidget {
  final CameraDescription camera;

  const ScanFaceForm({Key key, this.camera}) : super(key: key);

  @override
  _ScanFaceFormState createState() => _ScanFaceFormState();
}

class _ScanFaceFormState extends State<ScanFaceForm> {
